    ...
    <>
      ...
      <div className="main-wrapper relative">
        ...
        <div className="mt-10 pb-20 md:pb-0 social-container gap-8 flex w-full justify-center items-center">
          <a href="https://t.me/KnightOnCraft" className="hover:scale-125 transition-all duration-500 ease-in-out" target="_blank">
          ...
          <a href="https://twitter.com/KnightOnCraft" className="hover:scale-125 transition-all duration-500 ease-in-out" target="_blank">
